...
operation_func = (
    lambda *args: print("Answer: {0}".format(calc.addition(*args))),
    lambda *args: print("Answer: {0}".format(calc.subtraction(*args))),
    lambda *args: print("Answer: {0}".format(calc.multiplication(*args))),
    lambda *args: print("Answer: {0}".format(calc.division(*args))),
    lambda x, y: print("Answer: {0}".format(calc.modulo(x, y))),
    lambda x, y: print("Answer: {0}".format(calc.exponent(x, y))),
    lambda x, y: print("Answer: {0}".format(calc.root_extration(x, y)))
)
